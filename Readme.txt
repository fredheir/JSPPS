...
The style is based on the "Chicago Manual of Style 16th edition (full note)", written by Julian Onions (julian.onions[_at_]gmail.com).
https://www.zotero.org/styles/chicago-fullnote-bibliography

This is an early version of the style, created primarily for my own needs. Aspects of the style guide are likely not implemented, and errors should be expected. 
